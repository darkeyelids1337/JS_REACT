        ...
        <div className="movie-info">
            ...
            <div className="top">
                <div className="picture">
                    <img src={posterUrl} alt = 'oops' width='300px' height = '350px' onError={({currentTarget}) => {
                ...
                <div className="top-info">
                    <div className="top-left-info">
                        ...
                        <p><span className ='special'>Year:</span> {year}</p>
                        <p><span className ='special'>Genres:</span> {genres.join(", ")}</p>
                    </div>
                    <div className="top-right-info">
                        <h3>Actors:</h3>
                        <ul>{actorsArray.map((item, index) => {
                            return(
